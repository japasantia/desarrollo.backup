...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/MainWindow/img/cendit_logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/MainWindow/img/cendit-logo.png")));
