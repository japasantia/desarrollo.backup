...
ROM USB_DEV_DSC device_dsc=
{
    ...
    0xAB1A,                 // Vendor ID: Microchip
    // 0x003C,                 // Product ID: HID Bootloader
    0x105E,                 // Product ID: HID Bootloader
...
/*
ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[36];}sd001={
sizeof(sd001),DSC_STR,
'J','o','s','e',' ','A','r','i','a','s',' ','B',',',
...
ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[20];}sd001={
sizeof(sd001),DSC_STR,
'w','w','w','.','j','o','s','e','a','r','i','a','s','.','c','o','m','.','v','e'};

ROM struct{uint8_t bLength;uint8_t bDscType;uint16_t string[25];}sd002={
sizeof(sd002),DSC_STR,
'J','o','s','e',' ','A','r','i','a','s',' ','B','.',' ',
