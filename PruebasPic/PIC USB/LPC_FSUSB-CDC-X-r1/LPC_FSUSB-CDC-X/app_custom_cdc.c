...
/** P R I V A T E  C O N S T A N T  S T R I N G S *****************************/
  ...
  const char strVersion[]   = "Version 1.2";
  const char strDate[]      = "22. July 2014";
...
void APP_cmd(void)
{
    switch (usbOutBuffer[1]) {
        case CMD_INIT: // std. ACK is generated below
            break;
//------------------------------------------------------------------------------
        case CMD_DEVICE: // send device identification string
            usbInBuffer[1] = CMD_DEVICE | ID_MESSAGE;
            ...
            Flags.IN_TODO = 1;
            break;
        case CMD_VERSION:// send version info-string
            usbInBuffer[1] = CMD_VERSION | ID_MESSAGE;
...
//------------------------------------------------------------------------------
        ...
        case CMD_LED4_TOG:
            ...
            break;
        case CMD_BUTTON:
            usbInBuffer[1] = CMD_BUTTON | ID_MESSAGE;
        ...
        case CMD_POTI:
            ConvertADC();
            usbInBuffer[1] = CMD_POTI | ID_MESSAGE;
            while (BusyADC()) {
                ;
            }
